...
const AgentCard: React.FC<AgentCardProps> = ({
    ...
    return (
        <div className={`relative overflow-hidden p-6 rounded-[2rem] border transition-all duration-700 h-full flex flex-col ${isActive
                ? 'bg-white/[0.04] border-accent/40 shadow-[0_0_50px_-12px_rgba(var(--color-accent-rgb),0.3)] -translate-y-2'
