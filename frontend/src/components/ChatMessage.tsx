    ...
    const handleExportPDF = () => {
        ...
        try {
            ...
            const createCoverPage = () => {
                ...
                doc.text("GENERATED BY ANTIGRAVITY ORCHESTRATOR v2.0", margin + 10, pageHeight / 2 + 25);
            ...
            const addHeader = (pageNum: number) => {
                ...
                doc.text("ANTIGRAVITY SDLC ORCHESTRATOR - TECHNICAL BLUEPRINT", margin, 14);
                doc.setFont('helvetica', 'normal');
            ...
            const addFooter = () => {
                ...
                doc.setFontSize(7);
                doc.setTextColor(148, 163, 184);
                doc.text(`© ${new Date().getFullYear()} Antigravity Systems. Technical Intelligence Division.`, margin, pageHeight - 12);
